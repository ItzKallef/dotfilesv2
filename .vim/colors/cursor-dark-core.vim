...
let g:colors_name = "cursor-dark-core"
...
let s:background = { "gui": "#111111" }
let s:foreground = { "gui": "#aaaaaa" }
...
call s:setGuiColor("MatchParen", { "fg": s:yellow, "bg": s:darkYellow, "gui": "bold" })
