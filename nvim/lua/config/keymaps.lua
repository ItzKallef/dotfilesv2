...
map("n", "<S-Right>", ":vsplit<CR>", opts) -- Vertical split (right)
map("n", "<S-Left>", ":vsplit<CR>", opts) -- Vertical split (left)
map("n", "<S-Down>", ":split<CR>", opts) -- Horizontal split (below)
map("n", "<S-Up>", ":split<CR>", opts) -- Horizontal split (above)
map("n", "<C-S-Up>", "<C-w>k", opts) -- Move up
map("n", "<C-S-Down>", "<C-w>j", opts) -- Move down
map("n", "<C-S-Left>", "<C-w>h", opts) -- Move left
map("n", "<C-S-Right>", "<C-w>l", opts) -- Move right
map("n", "<Leader>wd", ":close<CR>", opts) -- Delete window
