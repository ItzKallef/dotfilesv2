...
set termguicolors
highlight Normal guibg=#111416 ctermbg=NONE
...
nnoremap <C-d> yyp
nnoremap <C-o> :AerialToggle<CR>
highlight CocUnderline gui=NONE guifg=NONE guibg=NONE

" Xcode build
" Project & Build Settings
let g:xcode_proj = "Editor.xcodeproj"
let g:xcode_scheme = "Editor"
let g:xcode_config = "Debug"
let g:xcode_build_dir = "build"

command! XBuild execute
      \ '!xcodebuild -scheme ' . g:xcode_scheme .
      \ ' -configuration ' . g:xcode_config .
      \ ' -project ' . g:xcode_proj .
      \ ' CONFIGURATION_BUILD_DIR=./' . g:xcode_build_dir . '/' . g:xcode_config .
      \ ' build'


command! XRun execute '!./' . g:xcode_build_dir . '/' . g:xcode_config . '/' . g:xcode_scheme


command! XRunApp execute
      \ '!xcodebuild -scheme ' . g:xcode_scheme .
      \ ' -configuration ' . g:xcode_config .
      \ ' -project ' . g:xcode_proj .
      \ ' CONFIGURATION_BUILD_DIR=./' . g:xcode_build_dir . '/' . g:xcode_config .
      \ ' build && open ./' . g:xcode_build_dir . '/' . g:xcode_config . '/' . g:xcode_scheme . '.app'


noremap <C-x> :XBuild<CR>
noremap <C-r> :XRun<CR>
noremap <C-a> :XRunApp<CR>
